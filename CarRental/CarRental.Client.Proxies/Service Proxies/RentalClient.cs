...
namespace CarRental.Client.Proxies
{
    ...
    public class RentalClient : UserClientBase<IRentalService>, IRentalService
    {
        ...
        {
            return Channel.RentCarToCustomerImmediate(loginEmail, carId, dateDueBack);
        }
        ...
        public Task<Rental> RentCarToCustomerImmediateAsync(string loginEmail, int carId, DateTime dateDueBack)
        {
            return Channel.RentCarToCustomerImmediateAsync(loginEmail, carId, dateDueBack);
        }
