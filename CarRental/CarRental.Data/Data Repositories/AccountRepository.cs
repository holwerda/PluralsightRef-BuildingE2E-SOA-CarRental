...
namespace CarRental.Data.Data_Repositories
{
    ...
    public class AccountRepository : DataRepositoryBase<Account>, IAccountRepository
    {
        ...
        {
            return (from e in entityContext.AccountSet where e.AccountId == entity.AccountId select e).FirstOrDefault();
        }
        ...
        public Account GetByLogin(string login)
        {
            ...
            {
                return (from a in entityContext.AccountSet where a.LoginEmail == login select a).FirstOrDefault();
            }
        }
    }
}
